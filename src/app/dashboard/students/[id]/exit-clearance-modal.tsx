...
const inp =
  "w-full rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white text-gray-700";
            ...
            <>
              <div className="rounded-lg bg-green-50 border border-green-200 px-4 py-3">
                ...
                <p className="text-xs text-green-700 mt-0.5">
                  This student will exit as <strong>Exited-Cleared</strong> and
                  receive a Transfer Certificate.
                </p>
              </div>
              ...
              <form action={clearFormAction}>
                ...
                >
                  {clearPending
                    ? "Processing…"
                    : "Confirm withdrawal — Exited-Cleared"}
                </button>
              </form>
            </>
          ) : (
            <>
              <div className="rounded-lg bg-red-50 border border-red-200 px-4 py-3">
                ...
                <p className="text-xs text-red-700 mt-0.5">
                  Withdrawing now will exit this student as{" "}
                  <strong>Exited-Unresolved</strong> — no Transfer Certificate
                  is issued, and this flags the record for other schools. To
                  issue clearance instead, settle the balance first (Edit →
                  Current balance), then reopen this dialog.
                </p>
              </div>
              ...
              >
                ...
                <label className="text-sm font-medium text-gray-700">
                  Reason for exiting with a balance still owed
                </label>
                <textarea
                  name="reason"
                  rows={2}
                  placeholder="e.g. Parent relocated, unreachable after repeated invoices…"
                  className={inp}
                />
                <button
                  type="submit"
                ...
                >
                  {withdrawPending
                    ? "Processing…"
                    : "Confirm withdrawal — Exited-Unresolved"}
                </button>
              </form>
            </>
          )}
